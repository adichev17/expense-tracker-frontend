...
const ExpenseCategoryScreen: FunctionComponent<IScreen> = ({ navigation, route }) => {
  ...
  return (
    <TheLayout>
      <TopPanel withBack navigation={navigation} backPathname="Expense" backParams={{ cardId: route.params.cardId }} />
      <View style={styles.body}>
        <Label>Создание категории расхода</Label>
